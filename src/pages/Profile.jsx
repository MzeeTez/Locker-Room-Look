...
  const [isEditing, setIsEditing] = useState(false)
  ...
  // FIX: Navigation side effects should be in useEffect
  useEffect(() => {
    if (!user) {
      navigate('/login')
    }
...
    setUser({ ...user, name: profileData.fullName, email: profileData.email })
    setIsEditing(false)
